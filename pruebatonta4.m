...
%%%%%%%%%%%% 1 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%% mOD1_PF_ 1DAY 5 DAY BACK _No Optimization
%1 cargo matriz
...
%%%%%%%%%%%%%%%%%%% 2 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%DONE %%%%%%%%%%%%%%% mod2_PF_ 1DAY 5 DAY BACK_No optimizatoni %%%%%%%%%%%%%%
%1 cargo matriz
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,1,guidata(hObject)),b13,[]) %cargo matriz 1.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,2,guidata(hObject)),b13,[]) %cargo matriz 2.
feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,3,guidata(hObject)),b13,[]) %cargo matriz 3.
...
%%%%%%%%%%%%%%%%%%3 %%%%%%%%%%%%%%%
%done %%%%%%%%%%%%%%% CLASSIC1_PF_ 1DAY 5 DAY BACK No optimization %%%%%%%%%%%%%%
%1 cargo matriz
feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,1,guidata(hObject)),b13,[]) %cargo matriz 1.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,2,guidata(hObject)),b13,[]) %cargo matriz 2.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,3,guidata(hObject)),b13,[]) %cargo matriz 3.
...
%%%%%%%%%%%%%%%%%%% 4 %%%%%%%%%%%%%%% done
%%%%%%%%%%%%%%%  cLASSIC2_PF_ 1DAY 5 DAY BACK no optimization %%%%%%%%%%%%%%
%1 cargo matriz
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,1,guidata(hObject)),b13,[]) %cargo matriz 1.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,2,guidata(hObject)),b13,[]) %cargo matriz 2.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,3,guidata(hObject)),b13,[]) %cargo matriz 3.
...
%%%%%%%%%%% 5 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%% CLASSIC1_PF_ 1DAY 10 DAY BACK no optim%%%%%%%%%%%%%%
%1 cargo matriz
feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,1,guidata(hObject)),b13,[]) %cargo matriz 1.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,2,guidata(hObject)),b13,[]) %cargo matriz 2.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,3,guidata(hObject)),b13,[]) %cargo matriz 3.
...
%%%%%%%%%%%%%%%%% 6 %%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%  cLASSIC2_PF_ 1DAY 10 DAY BACK no optim %%%%%%%%%%%%%%
%1 cargo matriz
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,1,guidata(hObject)),b13,[]) %cargo matriz 1.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,2,guidata(hObject)),b13,[]) %cargo matriz 2.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,3,guidata(hObject)),b13,[]) %cargo matriz 3.
...
%%%%%%%%%%%%%%% 12 %%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%  sin optim cLASSIC2_PF_ 1week 5 DAY BACK %%%%%%%%%%%%%%
%1 cargo matriz
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,1,guidata(hObject)),b13,[]) %cargo matriz 1.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,2,guidata(hObject)),b13,[]) %cargo matriz 2.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,3,guidata(hObject)),b13,[]) %cargo matriz 3.
...
%%%%%%%%%%%%%%%%%%%%% 16
%%%%%%%%%%%%%%% classic2_2 7 day forecast 7 day backward with opt %%%%%%%%%%%%%%
%1 cargo matriz
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,1,guidata(hObject)),b13,[]) %cargo matriz 1.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,2,guidata(hObject)),b13,[]) %cargo matriz 2.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,3,guidata(hObject)),b13,[]) %cargo matriz 3.
...
%%%%%%%%%%%%%%% 17 %%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%% classic2_EKF_7 day forecast 7 day backward with opt %%%%%%%%%%%%%%
%1 cargo matriz
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,1,guidata(hObject)),b13,[]) %cargo matriz 1.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,2,guidata(hObject)),b13,[]) %cargo matriz 2.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,3,guidata(hObject)),b13,[]) %cargo matriz 3.
...
%%%%%%%%% 19 %%%%%%%%%%%%%%
%%%%%%%%%%%%%%% mod1_1 7 day forecast 7 day backward with opt %%%%%%%%%%%%%%
%1 cargo matriz
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,1,guidata(hObject)),b13,[]) %cargo matriz 1.
feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,2,guidata(hObject)),b13,[]) %cargo matriz 2.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,3,guidata(hObject)),b13,[]) %cargo matriz 3.
...
%%%%%%%%%%%%%%% 20 %%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%% mod1_EKF_7 day forecast 7 day backward with opt %%%%%%%%%%%%%%
%1 cargo matriz
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,1,guidata(hObject)),b13,[]) %cargo matriz 1.
feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,2,guidata(hObject)),b13,[]) %cargo matriz 2.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,3,guidata(hObject)),b13,[]) %cargo matriz 3.
...
%%%%%%%%%%%%%% 21 %%%%%%%%%%%%%%%
%%%%%%%%%%%%%%% mod1_1_EKF day 7 forecast 7 day backward sin opt %%%%%%%%%%%%%%
%1 cargo matriz
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,1,guidata(hObject)),b13,[]) %cargo matriz 1.
feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,2,guidata(hObject)),b13,[]) %cargo matriz 2.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,3,guidata(hObject)),b13,[]) %cargo matriz 3.
...
%%%%%%%%%%%%%%% mod3_1_EKF day forecast 10 day backward sin opt %%%%%%%%%%%%%%
%1 cargo matriz
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,1,guidata(hObject)),b13,[]) %cargo matriz 1.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,2,guidata(hObject)),b13,[]) %cargo matriz 2.
feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,3,guidata(hObject)),b13,[]) %cargo matriz 3.
...
%%%%%%%%%%%%%%% Mod3_PF 1 day forecast 5 day backward con opt %%%%%%%%%%%%%%
%1 cargo matriz
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,1,guidata(hObject)),b13,[]) %cargo matriz 1.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,2,guidata(hObject)),b13,[]) %cargo matrizfeval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,3,guidata(hObject)),b13,[]) %cargo matriz 3.
feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,3,guidata(hObject)),b13,[]) %cargo matriz 4.
...
%%%%%%%%%%%%%%% Mod1_PF 1 day forecast 5 day backward sin opt %%%%%%%%%%%%%%
%1 cargo matriz
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,1,guidata(hObject)),b13,[]) %cargo matriz 1.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,2,guidata(hObject)),b13,[]) %cargo matrizfeval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,3,guidata(hObject)),b13,[]) %cargo matriz 3.
feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,3,guidata(hObject)),b13,[]) %cargo matriz 3.
...
%%%%%%%%%%%%%%% Mod3 1 day forecast 10 day backward cin opt %%%%%%%%%%%%%%
%1 cargo matriz
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,1,guidata(hObject)),b13,[]) %cargo matriz 1.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,2,guidata(hObject)),b13,[]) %cargo matrizfeval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,3,guidata(hObject)),b13,[]) %cargo matriz 3.
feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,3,guidata(hObject)),b13,[]) %cargo matriz 4.
...
%%%%%%%%%%%%%%% Mod3 ekf  1 day forecast 10 day backward cin opt %%%%%%%%%%%%%%
%1 cargo matriz
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,1,guidata(hObject)),b13,[]) %cargo matriz 1.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,2,guidata(hObject)),b13,[]) %cargo matrizfeval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,3,guidata(hObject)),b13,[]) %cargo matriz 3.
feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,3,guidata(hObject)),b13,[]) %cargo matriz 4.
...
%%%%%%%%%%%%%%% Mod3 ekf  1 day forecast 10 day backward sin opt %%%%%%%%%%%%%%
%1 cargo matriz
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,1,guidata(hObject)),b13,[]) %cargo matriz 1.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,2,guidata(hObject)),b13,[]) %cargo matrizfeval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,3,guidata(hObject)),b13,[]) %cargo matriz 3.
feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,3,guidata(hObject)),b13,[]) %cargo matriz 4.
...
%%%%%%%%%%%%%%% Mod3_PF 1 day forecast 10 day backward con opt %%%%%%%%%%%%%%
%1 cargo matriz
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,1,guidata(hObject)),b13,[]) %cargo matriz 1.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,2,guidata(hObject)),b13,[]) %cargo matrizfeval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,3,guidata(hObject)),b13,[]) %cargo matriz 3.
feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,3,guidata(hObject)),b13,[]) %cargo matriz 4.
...
%%%%%%%%%%%%%%% Mod1_PF 1 day forecast 10 day backward sin opt %%%%%%%%%%%%%%
%1 cargo matriz
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,1,guidata(hObject)),b13,[]) %cargo matriz 1.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,2,guidata(hObject)),b13,[]) %cargo matrizfeval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,3,guidata(hObject)),b13,[]) %cargo matriz 3.
feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,3,guidata(hObject)),b13,[]) %cargo matriz 4.
