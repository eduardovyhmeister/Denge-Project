...
function x =dengueODE10_Modified(x, nclus, Temperature, k0, ep, Tp,Tl,Ti,Te,Pre01,Pre02,Pre03, mu1, mu2, mu3, mu4, mu5,mu6,nenv)
tspan=getappdata(0,'TSPAN');
[t,y3]=ode23tb(@(t,x) laODE(t,x,nclus,Temperature,k0,ep, Tp,Tl,Ti,Te,Pre01,Pre02,Pre03,mu1,mu2,mu3,mu4,mu5,mu6,nenv),tspan,x);
x=y3(end,:)';
end
