...
function z=dengueODE12(x,nclus,q, Nh, Nv,uv,uh,kv,kh,gama,alpha,pv,ph,tau,pNoise)

tspan=getappdata(0,'TSPAN');
for i=1:size(x,2)
input=x(:,i);
[t,y3]=ode23tb(@(t,input) laODE(t,input,nclus,q,uv,uh,kv,kh,gama,alpha,pv,ph,tau),tspan,input);
