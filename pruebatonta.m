...
%%%%%%%%%%%%%%% mod2_EKF_day forecast 10_day backward %%%%%%%%%%%%%%
%1 cargo matriz
...
%    set(Ch3,'Value',0) %sin optimizacio
set(b3,'Value',1) %EKF
...
%%%%%%%%%%%%%%% mod2 1_day forecast 10_day backward %%%%%%%%%%%%%%
%1 cargo matriz
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,1,guidata(hObject)),b13,[]) %cargo matriz 1.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,2,guidata(hObject)),b13,[]) %cargo matriz 2. itquitos2
feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,3,guidata(hObject)),b13,[]) %cargo matriz 3. iquitos3
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,4,guidata(hObject)),b13,[]) %cargo matriz 4.
...
%%%%%%%%%%%%%%% mod1 1_day forecast 10_day backward %%%%%%%%%%%%%%
%1 cargo matriz
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,1,guidata(hObject)),b13,[]) %cargo matriz 1.
feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,2,guidata(hObject)),b13,[]) %cargo matriz 2. itquitos2
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,3,guidata(hObject)),b13,[]) %cargo matriz 3. iquitos3
...
%%%%%%%%%%%%%%% mod1_EKF_day forecast 10_day backward %%%%%%%%%%%%%%
%1 cargo matriz
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,1,guidata(hObject)),b13,[]) %cargo matriz 1.
feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,2,guidata(hObject)),b13,[]) %cargo matriz 2.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,3,guidata(hObject)),b13,[]) %cargo matriz 3.
...
%%%%%%%%%%%%%%% mod2_EKF_day forecast 10_day backward_sinoptimizacino %%%%%%%%%%%%%%
%1 cargo matriz
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,1,guidata(hObject)),b13,[]) %cargo matriz 1.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,2,guidata(hObject)),b13,[]) %cargo matriz 2.
feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,3,guidata(hObject)),b13,[]) %cargo matriz 3.
...
%%%%%%%%%%%%%%% mod1_EKF_day forecast 10_day backward SIN OPTIMIZACION %%%%%%%%%%%%%%
%1 cargo matriz
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,1,guidata(hObject)),b13,[]) %cargo matriz 1.
feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,2,guidata(hObject)),b13,[]) %cargo matriz 2.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,3,guidata(hObject)),b13,[]) %cargo matriz 3.
...
%%%%%%%%%%%%%%% classic1_EKF 7 day forecast 5day backward %%%%%%%%%%%%%%
%1 cargo matriz
feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,1,guidata(hObject)),b13,[]) %cargo matriz 1.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,2,guidata(hObject)),b13,[]) %cargo matriz 2.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,3,guidata(hObject)),b13,[]) %cargo matriz 3.
...
%%%%%%%%%%%%%%% classic2_ekf 7 day forecast 5day backward %%%%%%%%%%%%%%
%1 cargo matriz
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,1,guidata(hObject)),b13,[]) %cargo matriz 1.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,2,guidata(hObject)),b13,[]) %cargo matriz 2.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,3,guidata(hObject)),b13,[]) %cargo matriz 3.
...
%%%%%%%%%%%%%%% classic1_EKF SIN OPTIMIZACION 7 day forecast 5day backward %%%%%%%%%%%%%%
%1 cargo matriz
feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,1,guidata(hObject)),b13,[]) %cargo matriz 1.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,2,guidata(hObject)),b13,[]) %cargo matriz 2.
%feval(@(hObject,eventdata)IngresoDatos('pushb50_Callback',hObject,3,guidata(hObject)),b13,[]) %cargo matriz 3.
